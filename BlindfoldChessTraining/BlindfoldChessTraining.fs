...
open BlindfoldChessMechanics.Model
        ...
        View.ContentPage(
          content = View.StackLayout(padding = Thickness 20.0, verticalOptions = LayoutOptions.Center,
            children = [ 
                ...
                View.Label(text = (Board.init |> Seq.length |> sprintf "%d"), horizontalOptions = LayoutOptions.Center, width=200.0, horizontalTextAlignment=TextAlignment.Center)
            ]))
