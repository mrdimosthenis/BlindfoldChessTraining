...
let rewind: Image.Value = Resources.image "icons.rewind"

let chevronLeft: Image.Value = Resources.image "icons.chevron_left"
...
let list: Image.Value = Resources.image "icons.list"
